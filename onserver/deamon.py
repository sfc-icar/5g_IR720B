...
class Websocket_Server():
    ...
    def message_received(self, client, server, message):
        ...
        with conn.cursor() as cursor:
            sql = "INSERT INTO gndr_main(time, lat, lon, alt, Current, RSSI, ECIO, IO, SINR, RSRQ, SNR, RSRP, s_pcid, s_rc, s_db, s_lband, s_State, p_pcid, p_rc, p_db, p_lband) VALUES ( % s, % s, % s, % s, % s, % s, % s, % s, % s, % s,% s, % s, % s, % s, % s, % s, % s, % s, % s, % s, % s, % s)"
